...
"""
A python2 version of odometry.py, since the Jetson is being picky
"""
...
def tick_cb(tick_msg, enc):
    # type: (std.Int64, encoderState) -> None
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        v_x = ((v_left + v_right) / float(2)) * K_P
        v_y = 0     # robot can't move sideways
        v_theta = ((v_left - v_right) / float(WHEEL_BASE)) * K_P   # unicycle model
